...
},{"../core/createError":10,"./../core/settle":13,"./../helpers/btoa":17,"./../helpers/buildURL":18,"./../helpers/cookies":20,"./../helpers/isURLSameOrigin":22,"./../helpers/parseHeaders":24,"./../utils":26,"_process":73}],4:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":3,"./adapters/xhr":3,"./helpers/normalizeHeaderName":23,"./utils":26,"_process":73}],16:[function(require,module,exports){
'use strict';
...
},{"./chai/assertion":30,"./chai/config":31,"./chai/core/assertions":32,"./chai/interface/assert":33,"./chai/interface/expect":34,"./chai/interface/should":35,"./chai/utils":49,"assertion-error":1}],30:[function(require,module,exports){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
...
},{"./flag":42,"assertion-error":1,"type-detect":64}],42:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./flag":42,"./getActual":43,"./objDisplay":53}],46:[function(require,module,exports){
/*!
...
},{"./addChainableMethod":36,"./addLengthGuard":37,"./addMethod":38,"./addProperty":39,"./compareByInspect":40,"./expectTypes":41,"./flag":42,"./getActual":43,"./getMessage":45,"./getOwnEnumerableProperties":46,"./getOwnEnumerablePropertySymbols":47,"./inspect":50,"./isNaN":51,"./isProxyEnabled":52,"./objDisplay":53,"./overwriteChainableMethod":54,"./overwriteMethod":55,"./overwriteProperty":56,"./proxify":57,"./test":58,"./transferFlags":59,"check-error":60,"deep-eql":61,"get-func-name":62,"pathval":63,"type-detect":64}],50:[function(require,module,exports){
...
},{"../config":31,"./getEnumerableProperties":44,"./getProperties":48,"get-func-name":62}],51:[function(require,module,exports){
/*!
 * Chai - isNaN utility
...
},{"type-detect":64}],62:[function(require,module,exports){
'use strict';
...
},{"axios":2}],66:[function(require,module,exports){
"use strict";
...
},{"./predicateBuilder":69,"./regExService":71}],67:[function(require,module,exports){
"use strict";
...
var queryModule = _interopRequireWildcard(require("./queryBuilder"));
  ...
  return {
    build: function build(line) {
      ...
      return {
        ...
        toStringAsQuery: function toStringAsQuery() {
          return queryModule.builder.build("?-" + this.body.toString()).toString();
        },
        type: "NC",
        equals: function equals(nc) {
          return nc.toString() === this.toString();
        },
        arities: function arities() {
          return this.body.arities();
        },
        getQueryForProgram: function getQueryForProgram(program) {
...
},{"./bodyBuilder":66,"./queryBuilder":70}],68:[function(require,module,exports){
"use strict";
...
},{"./../IrisCaller":65,"./bodyBuilder":66}],71:[function(require,module,exports){
"use strict";
...
var ncModule = _interopRequireWildcard(require("../src/parser/ncBuilder"));
...
},{"../src/parser/ncBuilder":67,"chai":28}],73:[function(require,module,exports){
