...
var tgdModule = _interopRequireWildcard(require("../src/parser/tgdBuilder"));

var predicateModule = _interopRequireWildcard(require("../src/parser/predicateBuilder"));

var parameterModule = _interopRequireWildcard(require("../src/parser/parameterBuilder"));
...
},{"../core/createError":11,"./../core/settle":14,"./../helpers/btoa":18,"./../helpers/buildURL":19,"./../helpers/cookies":21,"./../helpers/isURLSameOrigin":23,"./../helpers/parseHeaders":25,"./../utils":27,"_process":74}],5:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":4,"./adapters/xhr":4,"./helpers/normalizeHeaderName":24,"./utils":27,"_process":74}],17:[function(require,module,exports){
'use strict';
...
},{"./chai/assertion":31,"./chai/config":32,"./chai/core/assertions":33,"./chai/interface/assert":34,"./chai/interface/expect":35,"./chai/interface/should":36,"./chai/utils":50,"assertion-error":2}],31:[function(require,module,exports){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
...
},{"../../chai":30,"./addLengthGuard":38,"./flag":43,"./proxify":58,"./transferFlags":60}],38:[function(require,module,exports){
...
},{"../../chai":30,"./addLengthGuard":38,"./flag":43,"./proxify":58,"./transferFlags":60}],40:[function(require,module,exports){
/*!
...
},{"../../chai":30,"./flag":43,"./isProxyEnabled":53,"./transferFlags":60}],41:[function(require,module,exports){
/*!
...
},{"./inspect":51}],42:[function(require,module,exports){
/*!
...
},{"./flag":43,"assertion-error":2,"type-detect":65}],43:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./flag":43,"./getActual":44,"./objDisplay":54}],47:[function(require,module,exports){
/*!
...
},{"./getOwnEnumerablePropertySymbols":48}],48:[function(require,module,exports){
/*!
...
},{"./addChainableMethod":37,"./addLengthGuard":38,"./addMethod":39,"./addProperty":40,"./compareByInspect":41,"./expectTypes":42,"./flag":43,"./getActual":44,"./getMessage":46,"./getOwnEnumerableProperties":47,"./getOwnEnumerablePropertySymbols":48,"./inspect":51,"./isNaN":52,"./isProxyEnabled":53,"./objDisplay":54,"./overwriteChainableMethod":55,"./overwriteMethod":56,"./overwriteProperty":57,"./proxify":58,"./test":59,"./transferFlags":60,"check-error":61,"deep-eql":62,"get-func-name":63,"pathval":64,"type-detect":65}],51:[function(require,module,exports){
...
},{"../config":32,"./getEnumerableProperties":45,"./getProperties":49,"get-func-name":63}],52:[function(require,module,exports){
/*!
 * Chai - isNaN utility
...
},{"../config":32}],54:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"../config":32,"./inspect":51}],55:[function(require,module,exports){
/*!
...
},{"../../chai":30,"./transferFlags":60}],56:[function(require,module,exports){
/*!
...
},{"../../chai":30,"./addLengthGuard":38,"./flag":43,"./proxify":58,"./transferFlags":60}],57:[function(require,module,exports){
/*!
...
},{"../../chai":30,"./flag":43,"./isProxyEnabled":53,"./transferFlags":60}],58:[function(require,module,exports){
var config = require('../config');
var flag = require('./flag');
var getProperties = require('./getProperties');
var isProxyEnabled = require('./isProxyEnabled');
...
},{"../config":32,"./flag":43,"./getProperties":49,"./isProxyEnabled":53}],59:[function(require,module,exports){
/*!
 * Chai - test utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"./flag":43}],60:[function(require,module,exports){
/*!
...
},{"type-detect":65}],63:[function(require,module,exports){
'use strict';
...
exports.getIarRepairs = getIarRepairs;
...
function executeQuery(programText, isGuarded, variablesToShowByQuery) {
  var internalParams = {
    program: programText,
    isGuarded: isGuarded
  };
  ...
  return _axios.default.get("http://localhost:8080/iris/query", {
    params: {
...
function getIarRepairs(_x, _x2, _x3, _x4) {
  return _getIarRepairs.apply(this, arguments);
}

function _getIarRepairs() {
  _getIarRepairs = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(facts, tgds, ncsAsQueries, isGuarded) {
    var params, result, response, json;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            result = [];
            _context.next = 4;
            return fetch('http://localhost:8080/iris/iar', {
              method: 'post',
          ...
          case 7:
            json = _context.sent;
            result = json.map(function (r) {
              return r.Facts.map(function (r) {
                return r.Text;
              });
            });
...
},{"axios":3}],67:[function(require,module,exports){
"use strict";
...
var predicateModule = _interopRequireWildcard(require("./predicateBuilder"));

var regExModule = _interopRequireWildcard(require("./regExService"));

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

function _builder() {
  var build = function build(bodyText) {
    ...
    return {
      ...
      hasVariable: function hasVariable(v) {
        return predicatesAsObjects.some(function (p) {
...
},{"./predicateBuilder":69,"./regExService":71}],68:[function(require,module,exports){
"use strict";
...
var parameterModule = _interopRequireWildcard(require("./parameterBuilder"));
...
function _builder(tgdText) {
  return {
    build: function build(predicateText) {
      ...
      var hasVariable = function hasVariable(v) {
        return parametersAsObjets.some(function (p) {
          return p.name == v;
        });
      };
      ...
      return {
        ...
        allVariables: parametersAsObjets.filter(function (p) {
          return p.type == 'variable';
        }).map(function (p) {
          return p.name;
        }),
        hasAllVariables: function hasAllVariables(variables) {
          return variables.every(function (v) {
            return hasVariable(v);
          });
        },
        isNegated: isNegated,
        toString: function toString() {
        ...
        countFor: function countFor(variable) {
          return this.parameters.filter(function (p) {
            return p.isEqualTo(variable);
          }).length;
        }
      };
    }
...
},{"./parameterBuilder":68,"./regExService":71}],70:[function(require,module,exports){
"use strict";
...
var bodyModule = _interopRequireWildcard(require("./bodyBuilder"));

var _IrisCaller = require("./../IrisCaller");

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

function _builder() {
  return {
    build: function build(queryText) {
      var body = bodyModule.builder.build(queryText.trim().substring(2));
      return {
        predicates: body.predicates,
        toString: function toString() {
          return ["?- ", body.toString(), "."].join("");
        },
        type: "QUERY",
        getAtmos: function getAtmos(indexes) {
          var _this = this;

          return indexes.map(function (i) {
            return _this.predicates[i];
          });
        },
        execute: function execute(program) {
          var programWithQuery = program.toStringWithoutNcsAndEgdsAndQueries() + "\n" + this.toString();
          return new Promise(function (resolve) {
            (0, _IrisCaller.executeQuery)(programWithQuery, program.isGuarded()).then(function (res) {
              resolve(res);
            });
          });
        },
        isSharedVariable: function isSharedVariable(parameter) {
          if (parameter.type == 'constant') {
            return false;
          } else {
            return this.predicates.map(function (p) {
              return p.countFor(parameter);
            }).reduce(function (a, b) {
              return a + b;
            }, 0) > 1;
          }
...
},{"./../IrisCaller":66,"./bodyBuilder":67}],71:[function(require,module,exports){
"use strict";
...
function _service() {
  ...
  return {
    ...
    arrayOfMatches: function arrayOfMatches(regEx, _text) {
      var f = function f(match) {
        return match[0];
      };

      return arrayOfMatchesTemplate(regEx, _text, f);
    },
    predicateRegExByNameAndArity: function predicateRegExByNameAndArity(predicateName, arity) {
      return new RegExp(predicateName + '\\(' + repeatAndSeparateNElementsByComma(variableOrConstantRegEx, arity).source + '\\)');
    },
    arrayOfIndexes: function arrayOfIndexes(regEx, _text) {
      var f = function f(match) {
        return {
          start: match.index,
...
var _mguBuilder = require("../rewrite/mguBuilder");

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {}; if (desc.get || desc.set) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; return newObj; } }

function _builder() {
  var buildTgdHeadPredicate = function buildTgdHeadPredicate(predicateText, tgdBody) {
    var predicate = predicateModule.builder.build(predicateText);
    var variables = predicate.parameters.filter(function (p) {
      return p.type == 'variable';
    ...
    return {
      ...
      renameVariablesAndNulls: function renameVariablesAndNulls(setOfAtoms) {
        var renamedParameters = [];
        this.parameters.forEach(function (p) {
          if (p.type == 'null' || p.type == 'variable') {
            if (setOfAtoms.some(function (a) {
              return a.hasVariable(p.name);
            })) {
        ...
        return {
          ...
          toString: function toString() {
            return this.name + "(" + renamedParameters.map(function (p) {
              return p.toString();
            }).join(", ") + ")";
          },
  ...
  var buildTgdHead = function buildTgdHead(headText, tgdBody) {
    return {
  ...
  return {
    build: function build(line) {
      ...
      var isGuarded = body.predicates.some(function (p) {
        return p.hasAllVariables(allVariables);
      });
      return {
        body: body,
        head: head,
        ...
        xPositionsInHead: function xPositionsInHead() {
          var result = [];
          this.head.predicate.parameters.forEach(function (parameter, index) {
        ...
        allNullsAppearOnlyOnceInTheHead: function allNullsAppearOnlyOnceInTheHead() {
          var allNullNames = this.head.predicate.parameters.filter(function (p) {
            return p.type == 'null';
          }).map(function (p) {
            return p.name;
          });
        ...
        isApplicableTo: function isApplicableTo(query, indexes) {
          var atoms = query.getAtoms(indexes);

          var _nullPosition = this.nullPosition();

          return (0, _mguBuilder.getMguFor)(atoms, this.head).unfies && _nullPosition != -1 && query.getAtoms(indexes).all(function (a) {
            return a.parameters[_nullPosition].type != 'constant' && !query.isSharedVariable(a.parameters[_nullPosition]);
          });
        },
        nullPosition: function nullPosition() {
          var found = false;
          var i = 0;
...
},{"../rewrite/mguBuilder":73,"./bodyBuilder":67,"./parameterBuilder":68,"./predicateBuilder":69}],73:[function(require,module,exports){
"use strict";
