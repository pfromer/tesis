...
/**
 * <p>
 * An atom (an atomic formula) is a formula that has no subformulas. Atom consists of a predicate symbol and a tuple (a
 * list of arguments), e.g., p(A1,...,An), where p is a predicate symbol and A1,...,An is a tuple (a list of arguments).
 * </p>
 * 
 * <p>
