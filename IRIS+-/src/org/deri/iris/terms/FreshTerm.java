 ...
 */
public class FreshTerm extends ConstructedTerm implements IFreshTerm {

	private final int freshTermIndex;

	FreshTerm(final IPredicate pred, final int posIndex, final int freshTermIndex, final Collection<ITerm> terms) {
