...
public class RepairsFinder {
	...
	private void getSubsets(List<Integer> superSet, int k, int idx, List<Integer> current, List<List<Integer>> solution) {
		if (current.size() == k) {
	...
	public List<List<Integer>> getSubsets(List<Integer> superSet, int k) {
