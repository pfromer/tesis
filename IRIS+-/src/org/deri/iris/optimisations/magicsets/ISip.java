...
public interface ISip {
     ...
     */
    Set<LabeledEdge<ILiteral, Set<IVariable>>> getEdgesEnteringLiteral(
	    ILiteral literal);
     ...
     *             if the literal is <code>null</code>
     */
    Set<LabeledEdge<ILiteral, Set<IVariable>>> getEdgesLeavingLiteral(
	    ILiteral literal);
     ...
     * @return the set of variables
     * @throws IllegalArgumentException
     *             if one of the literal is <code>null</code>
     */
