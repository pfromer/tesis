...
import org.deri.iris.parser.node.ADirectiveExpr;
...
public class ReversedDepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void inADirectiveExpr(ADirectiveExpr node)
    {
        defaultIn(node);
    }

    public void outADirectiveExpr(ADirectiveExpr node)
    {
        defaultOut(node);
    }
    ...
    public void caseADirective(ADirective node)
    {
        ...
        if(node.getDirname() != null)
        {
            node.getDirname().apply(this);
        }
        outADirective(node);
    }
    ...
    public void inADirname(ADirname node)
    {
        defaultIn(node);
    }

    public void outADirname(ADirname node)
    {
        defaultOut(node);
    }
    ...
    public void caseADirname(ADirname node)
    {
        ...
        if(node.getTDash() != null)
        {
            node.getTDash().apply(this);
        }
        outADirname(node);
    }
