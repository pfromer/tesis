...
public class PredicateGraph implements IPredicateGraph {
	...
	/**
	 * Connectivity inspector to determine, whether paths between vertices exists.
	 */
	...
	private void _addRule(final IRule rule) {
		...
		for (final ILiteral h : rule.getHead()) {
			...
			for (final ILiteral l : rule.getBody()) {
				...
				final LabeledEdge<IPredicate, Boolean> e = new LabeledEdge<IPredicate, Boolean>(p, hp, l.isPositive());
	...
	public Set<LabeledEdge<IPredicate, Boolean>> findEdgesForCycle() {
		...
		final Set<LabeledEdge<IPredicate, Boolean>> edges = new HashSet<LabeledEdge<IPredicate, Boolean>>();
	...
	/**
	 * <p>
	 * Computes a short description of this object. <b>The format of the returned string is undocumented and subject to
	 * change.</b>.
	 * </p>
	 * <p>
	...
	private class RuleComparator implements Comparator<IRule> {
		...
		public int compare(final IRule o1, final IRule o2) {
			...
			return pc.compare(o1.getHead().iterator().next().getAtom().getPredicate(), o2.getHead().iterator().next()
	 ...
	 * </p>
	 * <p>
	 * If one of the compared predicate isn't in the graph, or there isn't a path from one predicate to the other
	 * {@code 0} will be returned. If the first predicate depends on the second one, the first one will be determined to
	...
	private class PredicateComparator implements Comparator<IPredicate> {
		...
		public int compare(final IPredicate o1, final IPredicate o2) {
			...
			if (!g.containsVertex(o1) || !g.containsVertex(o2) || !ci.pathExists(o1, o2))
				return 0;
	...
	/**
	 * <p>
	 * The simple factory to create default edges for the PredicateGraph. The label of the edge will be
	 * <code>true</code>.
	 * </p>
	 * <p>
	 * $Id$
