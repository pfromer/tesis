...
public class StandardFloatingPointComparator implements
    ...
    /**
     * Singleton-like method to get the standard setup for dealing with double
     * type.
     * 
    ...
    /**
     * Singleton-like method to get the standard setup for dealing with float
     * type.
     * 
     ...
     * Constructor.
     * 
     * @param numberOfSignificantBits
     *            The number of significant bits in the significand to use when
     *            comparing values. If a non-standard setup is used then it is
     *            up to the user to set this value correctly.
     */
     ...
     * @param b
     *            A double value
     * @return true If a and b are exactly the same or close enough to being
     *         equal.
     */
	...
	// Need some bottom limit, otherwise it's impossible to properly compare
	// anything to zero.
	// When the magnitude of both numbers is below this then treat both as
	// zero.
    ...
    /**
     * The standard number of least significant bits to ignore for a double
     * type.
     */
    ...
    public static final IFloatingPointComparator mStandardDoubleInstance = new StandardFloatingPointComparator(
	    BINARY_DIGITS_OF_PRECISION_DOUBLE
		    - LEAST_SIGNIFICANT_BINARY_DIGITS_TO_IGNORE_DOUBLE);

    /** The standard comparator for float types. */
    public static final IFloatingPointComparator mStandardFloatInstance = new StandardFloatingPointComparator(
