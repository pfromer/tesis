...
public class GreaterEqualBuiltinTest extends TestCase {
	...
	final GreaterEqualBuiltin xy = new GreaterEqualBuiltin(TERM
	...
	assertNull("a shouldn't be greater than b", xy.evaluate(BASIC
		.createTuple(TERM.createString("a"), TERM.createString("b"))));
	assertNotNull("a should be greater-equal to a", xy.evaluate(BASIC
		.createTuple(TERM.createString("a"), TERM.createString("a"))));

	assertEquals(null, xy.evaluate(BASIC.createTuple(CONCRETE
