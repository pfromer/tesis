...
public class MultiplyBuiltinEvaluationTest extends TestCase {
	...
	List<ILiteral> b = Arrays.asList(createLiteral("p1", "S", "I"),
		...
		Factory.BASIC
			.createLiteral(true, Factory.BUILTIN
				.createMultiplyBuiltin(
					TERM.createVariable("I"), TERM
						.createVariable("I"), TERM
						.createVariable("K"))),
		createLiteral("p2", "S"));
	...
	rel.add(BASIC.createTuple(TERM.createString("a"), CONCRETE
		.createInteger(1)));
	rel.add(BASIC.createTuple(TERM.createString("b"), CONCRETE
		.createInteger(2)));
	rel.add(BASIC.createTuple(TERM.createString("c"), CONCRETE
		.createInteger(3)));
	rel.add(BASIC.createTuple(TERM.createString("d"), CONCRETE
		.createInteger(12)));
	facts.put(p, rel);
	...
	res.add(BASIC.createTuple(TERM.createString("b"), CONCRETE
		.createInteger(4)));
