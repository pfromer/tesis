...
public class BuiltinHelperTest extends TestCase {
	...
	return new TestSuite(BuiltinHelperTest.class, BuiltinHelperTest.class
		.getSimpleName());
    }
	...
	assertEquals(Arrays.hashCode(new int[] { 1, 3, 5 }), Arrays
		.hashCode(BuiltinHelper.determineGround(Arrays
			.asList(new ITerm[] { A, I_2, B, S_a, C, D_55 }))));
	assertEquals(Arrays.hashCode(new int[] { 0, 1, 2, 3, 5 }), Arrays
		.hashCode(BuiltinHelper.determineGround(Arrays
			.asList(new ITerm[] { I_2, I_2, F_10, S_a, A, D_55 }))));
	assertEquals(Arrays.hashCode(new int[] {}), Arrays
		.hashCode(BuiltinHelper.determineGround(Arrays
			.asList(new ITerm[] { A, B, C }))));
	assertEquals(Arrays.hashCode(new int[] { 0, 1, 2 }), Arrays
		.hashCode(BuiltinHelper.determineGround(Arrays
			.asList(new ITerm[] { I_2, F_5, D_10 }))));
	assertEquals(Arrays.hashCode(new int[] {}), Arrays
		.hashCode(BuiltinHelper.determineGround(Arrays
			.asList(new ITerm[] {}))));
    }
	...
	assertEquals(Arrays.hashCode(new int[] { 0, 2, 4 }), Arrays
		.hashCode(BuiltinHelper.determineUnground(Arrays
			.asList(new ITerm[] { A, I_2, B, S_a, C, D_55 }))));
	assertEquals(Arrays.hashCode(new int[] { 4 }), Arrays
		.hashCode(BuiltinHelper.determineUnground(Arrays
			.asList(new ITerm[] { I_2, I_2, F_10, S_a, A, D_55 }))));
	assertEquals(Arrays.hashCode(new int[] { 0, 1, 2 }), Arrays
		.hashCode(BuiltinHelper.determineUnground(Arrays
	...
	assertEquals(Arrays.hashCode(new ITerm[] { I_5, F_2 }), Arrays
		.hashCode(BuiltinHelper.getIndexes(Arrays.asList(new ITerm[] {
			I_2, I_5, I_10, F_2 }), new int[] { 1, 3 })));
	assertEquals(Arrays.hashCode(new ITerm[] { I_10 }), Arrays
		.hashCode(BuiltinHelper.getIndexes(Arrays.asList(new ITerm[] {
			I_2, I_5, I_10, F_2 }), new int[] { 2 })));
	assertEquals(Arrays.hashCode(new ITerm[] {}), Arrays
		.hashCode(BuiltinHelper.getIndexes(Arrays.asList(new ITerm[] {
			I_2, I_5, I_10, F_2 }), new int[] {})));
    }
	...
	assertEquals(Arrays.hashCode(new int[] { 1, 3 }), Arrays
		.hashCode(BuiltinHelper.complement(new int[] { 0, 2, 4 }, 5)));
	assertEquals(Arrays.hashCode(new int[] { 0, 2, 4 }), Arrays
		.hashCode(BuiltinHelper.complement(new int[] { 1, 3 }, 5)));
	assertEquals(Arrays.hashCode(new int[] { 0, 1, 2, 3, 4 }), Arrays
		.hashCode(BuiltinHelper.complement(new int[] {}, 5)));
	assertEquals(Arrays.hashCode(new int[] {}), Arrays
		.hashCode(BuiltinHelper.complement(new int[] { 0, 1, 2, 3, 4 },
			5)));
    }
	...
	assertEquals(Arrays.hashCode(new ITerm[] { I_2, I_5, I_10, F_2 }),
		Arrays.hashCode(BuiltinHelper.concat(new int[] { 0, 3 },
			new ITerm[] { I_2, F_2 }, new ITerm[] { I_5, I_10 })));
	assertEquals(Arrays.hashCode(new ITerm[] { I_2, F_2, I_5, I_10 }),
		Arrays.hashCode(BuiltinHelper.concat(new int[] { 0, 1 },
			new ITerm[] { I_2, F_2 }, new ITerm[] { I_5, I_10 })));
	assertEquals(Arrays.hashCode(new ITerm[] { I_5, I_10, I_2, F_2 }),
		Arrays.hashCode(BuiltinHelper.concat(new int[] { 2, 3 },
			new ITerm[] { I_2, F_2 }, new ITerm[] { I_5, I_10 })));
	assertEquals(Arrays.hashCode(new ITerm[] { I_5, I_10 }), Arrays
		.hashCode(BuiltinHelper.concat(new int[] {}, new ITerm[] {},
			new ITerm[] { I_5, I_10 })));
	assertEquals(Arrays.hashCode(new ITerm[] { I_2, F_2 }), Arrays
		.hashCode(BuiltinHelper.concat(new int[] { 0, 1 }, new ITerm[] {
			I_2, F_2 }, new ITerm[] {})));
    }
	...
	final IDuration h1m1s1 = CONCRETE
		.createDuration(true, 0, 0, 0, 1, 1, 1);

	final IDateTime y2000m3d5h12m15s10 = CONCRETE.createDateTime(2000, 3,
		5, 12, 15, 10, 0, 0);
	final IDateTime y2000m3d4h12m15s10 = CONCRETE.createDateTime(2000, 3,
		4, 12, 15, 10, 0, 0);
	assertEquals("something wrong with datetime - duration.",
		y2000m3d4h12m15s10, BuiltinHelper.subtract(y2000m3d5h12m15s10,
			d1));
	...
	assertEquals("something wrong with date - date.", d1, BuiltinHelper
		.subtract(y2000m3d5, y2000m3d4));
	...
	assertEquals("something wrong with time - time.", h1m1s1, BuiltinHelper
		.subtract(h13m16s11, h12m15s10));

	assertEquals("somethond wrong with duration - duration.", CONCRETE
		.createDuration(true, 0, 0, 0, 22, 58, 59), BuiltinHelper
		.subtract(d1, h1m1s1));
	...
	final IDateTime y2000m3d4h12m15s10 = CONCRETE.createDateTime(2000, 3,
		4, 12, 15, 10, 0, 0);
	assertEquals("something wrong with datetime + duration.",
		y2000m3d5h12m15s10, BuiltinHelper.add(y2000m3d4h12m15s10, d1));
	assertEquals("something wrong with duration + datetime.",
		y2000m3d5h12m15s10, BuiltinHelper.add(d1, y2000m3d4h12m15s10));
	...
	assertEquals("somethond wrong with duration + duration.", CONCRETE
		.createDuration(true, 0, 0, 1, 1, 1, 1), BuiltinHelper.add(d1,
		h1m1s1));
	...
	assertEquals(
		"Shifting of the possitions with one second works not properly with datetimes",
		resultDT, BuiltinHelper.add(CONCRETE.createDateTime(1999, 12,
			31, 23, 59, 59, 0, 0), s1));
	assertEquals(
		"Shifting of the possitions with one minute works not properly with datetimes",
		resultDT, BuiltinHelper.add(CONCRETE.createDateTime(1999, 12,
	...
	assertEquals(
		"Shifting of the possitions with one day works not properly with dates",
		resultD, BuiltinHelper.add(CONCRETE.createDate(1999, 12, 31),
			d1));

	final ITime resultT = CONCRETE.createTime(0, 0, 0, 0, 0);
	assertEquals(
		"Shifting of the possitions with one second works not properly with times",
		resultT, BuiltinHelper.add(CONCRETE
			.createTime(23, 59, 59, 0, 0), s1));
	assertEquals(
		"Shifting of the possitions with one minute works not properly with times",
		resultT, BuiltinHelper.add(CONCRETE
			.createTime(23, 59, 00, 0, 0), m1));
	assertEquals(
		"Shifting of the possitions with one hour works not properly with times",
		resultT, BuiltinHelper.add(CONCRETE
			.createTime(23, 00, 00, 0, 0), h1));
    }

    /**
     * Tests some behaviours of the date operations, which don't have to make
     * sense.
     */
	...
	final IDuration d365 = CONCRETE
		.createDuration(true, 0, 0, 365, 0, 0, 0);
	final IDuration d366 = CONCRETE
		.createDuration(true, 0, 0, 366, 0, 0, 0);
	final IDuration d458 = CONCRETE
		.createDuration(true, 0, 0, 458, 0, 0, 0);
	final IDuration m11d30 = CONCRETE.createDuration(true, 0, 11, 30, 0, 0,
		0);
	final IDuration m11d31 = CONCRETE.createDuration(true, 0, 11, 31, 0, 0,
		0);
	...
	final IDuration diff = (IDuration) BuiltinHelper.subtract(y2005m2d28,
		y2004m2d29);
	// assertEquals(d365, diff);
	assertEquals(m11d30, diff);

	final IDuration diff2 = (IDuration) BuiltinHelper.subtract(y2005m2d28,
		y2004m2d28);
	...
	final IDateTime y2004m2d28 = CONCRETE.createDateTime(2004, 2, 28, 0, 0,
		0, 0, 0);
	final IDateTime y2004m2d27mu999999 = CONCRETE.createDateTime(2004, 2,
		27, 23, 59, 59.999999, 0, 0);
	final IDuration mu1 = CONCRETE.createDuration(true, 0, 0, 0, 0, 0,
		0.000001);

	assertEquals(y2004m2d27mu999999, BuiltinHelper
		.subtract(y2004m2d28, mu1));
