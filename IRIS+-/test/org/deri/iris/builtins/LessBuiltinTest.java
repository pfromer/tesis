...
public class LessBuiltinTest extends TestCase {
	...
	return new TestSuite(LessBuiltinTest.class, LessBuiltinTest.class
		.getSimpleName());
    }

    public void testEvaluation() throws Exception {
	final LessBuiltin xy = new LessBuiltin(TERM.createVariable("X"), TERM
		.createVariable("Y"));
	...
	assertNotNull("a should be less than b", xy.evaluate(BASIC.createTuple(
		TERM.createString("a"), TERM.createString("b"))));
	assertNull("a shouldn't be less to a", xy.evaluate(BASIC.createTuple(
