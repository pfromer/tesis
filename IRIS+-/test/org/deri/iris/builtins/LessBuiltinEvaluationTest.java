...
public class LessBuiltinEvaluationTest extends TestCase {
	...
	List<ILiteral> b = Arrays.asList(createLiteral("s", "X"), Factory.BASIC
		.createLiteral(true, Factory.BUILTIN.createLess(TERM
	...
	List<ILiteral> h = Arrays.asList(createLiteral("p", "X"));
	List<ILiteral> b = Arrays.asList(createLiteral("s", "X"), Factory.BASIC
		.createLiteral(true, Factory.BUILTIN.createLess(CONCRETE
			.createInteger(4), CONCRETE.createInteger(3))),
		createLiteral("r", "Y"));
	...
	IRelation rel = new RelationFactory().createRelation();
	rel.add(BASIC.createTuple(CONCRETE.createInteger(1), CONCRETE
		.createInteger(1)));
	rel.add(BASIC.createTuple(CONCRETE.createInteger(9), CONCRETE
		.createInteger(2)));
	rel.add(BASIC.createTuple(CONCRETE.createInteger(2), CONCRETE
		.createInteger(9)));
	facts.put(p, rel);
	...
	// Result: p(9,2)
	IRelation res = new RelationFactory().createRelation();
	res.add(BASIC.createTuple(CONCRETE.createInteger(9), CONCRETE
		.createInteger(2)));
	...
	IPredicate p = Factory.BASIC.createPredicate("s", 2);
	IRelation rel = new RelationFactory().createRelation();
	rel.add(BASIC.createTuple(BASIC.createTuple(CONCRETE.createDate(2000,
		5, 10), CONCRETE.createDate(2000, 5, 12))));
	rel.add(BASIC.createTuple(BASIC.createTuple(CONCRETE.createDate(2001,
		5, 10), CONCRETE.createDate(2000, 5, 10))));
	rel.add(BASIC.createTuple(BASIC.createTuple(CONCRETE.createDate(2000,
		4, 10), CONCRETE.createDate(2000, 5, 12))));
	facts.put(p, rel);
	...
	// org.deri.iris.terms.concrete.DateTerm[year=2000,month=5,day=5])
	IRelation res = new RelationFactory().createRelation();
	res.add(BASIC.createTuple(CONCRETE.createDate(2000, 5, 10), CONCRETE
		.createDate(2000, 5, 12)));
	res.add(BASIC.createTuple(CONCRETE.createDate(2000, 4, 10), CONCRETE
		.createDate(2000, 5, 12)));
