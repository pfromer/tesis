...
public class EqualBuiltinEvaluationTest extends TestCase {
	...
	rel.add(BASIC.createTuple(TERM.createString("b"), TERM
		.createString("b")));
	rel.add(BASIC.createTuple(TERM.createString("c"), TERM
		.createString("c")));
	facts.put(p, rel);
	...
	res.add(BASIC.createTuple(TERM.createString("a"), TERM
		.createString("b"), TERM.createString("b")));
	res.add(BASIC.createTuple(TERM.createString("a"), TERM
		.createString("c"), TERM.createString("c")));
	...
	IRelation res = new RelationFactory().createRelation();
	res.add(BASIC.createTuple(TERM.createString("b"), TERM
		.createString("b"), TERM.createString("b")));
	res.add(BASIC.createTuple(TERM.createString("c"), TERM
		.createString("c"), TERM.createString("c")));
	...
	IPredicate p = Factory.BASIC.createPredicate("r", 2);
	IRelation rel = new RelationFactory().createRelation();
	rel.add(BASIC.createTuple(TERM.createString("a"), TERM
		.createString("a")));
	rel.add(BASIC.createTuple(TERM.createString("b"), TERM
		.createString("b")));
	rel.add(BASIC.createTuple(TERM.createString("c"), TERM
