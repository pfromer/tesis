...
public class StandardFloatingPointComparatorTest extends TestCase {
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertEquals(StandardFloatingPointComparator.getDouble().compare(
		    scaledLower, scaledSame1), -1);
	    assertEquals(StandardFloatingPointComparator.getDouble().compare(
		    scaledSame1, scaledLower), +1);

	    assertEquals(StandardFloatingPointComparator.getDouble().compare(
		    scaledSame1, scaledSame2), 0);
	    assertEquals(StandardFloatingPointComparator.getDouble().compare(
		    scaledSame2, scaledSame1), 0);
	}
    }
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertTrue(StandardFloatingPointComparator.getDouble().less(
		    scaledLower, scaledSame1));
	    assertFalse(StandardFloatingPointComparator.getDouble().less(
		    scaledSame1, scaledSame2));
	    assertFalse(StandardFloatingPointComparator.getDouble().less(
		    scaledSame2, scaledSame1));
	}
    }
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertTrue(StandardFloatingPointComparator.getDouble().greater(
		    scaledSame1, scaledLower));
	    assertFalse(StandardFloatingPointComparator.getDouble().greater(
		    scaledSame1, scaledSame2));
	    assertFalse(StandardFloatingPointComparator.getDouble().greater(
		    scaledSame2, scaledSame1));
	}
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .greaterOrEquals(scaledSame1, scaledLower));
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .greaterOrEquals(scaledSame1, scaledSame2));
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .greaterOrEquals(scaledSame2, scaledSame1));
	}
    }
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .lessOrEquals(scaledLower, scaledSame1));
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .lessOrEquals(scaledSame1, scaledSame2));
	    assertTrue(StandardFloatingPointComparator.getDouble()
		    .lessOrEquals(scaledSame2, scaledSame1));
	}
    }
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertTrue(StandardFloatingPointComparator.getDouble().equals(
		    scaledSame1, scaledSame2));
	    assertTrue(StandardFloatingPointComparator.getDouble().equals(
		    scaledSame2, scaledSame1));
	    assertFalse(StandardFloatingPointComparator.getDouble().equals(
		    scaledSame1, scaledLower));
	}
    }
	...
	for (int scale = -10; scale <= +40; ++scale) {
	    ...
	    assertFalse(StandardFloatingPointComparator.getDouble().notEquals(
		    scaledSame1, scaledSame2));
	    assertFalse(StandardFloatingPointComparator.getDouble().notEquals(
		    scaledSame2, scaledSame1));
	    assertTrue(StandardFloatingPointComparator.getDouble().notEquals(
		    scaledSame1, scaledLower));
	}
    }

    public void testIsIntValue() {
	assertTrue(StandardFloatingPointComparator.getDouble().isIntValue(
		5.00000000000001));
	assertFalse(StandardFloatingPointComparator.getDouble().isIntValue(
		5.0000000001));
