...
public class GlobalStratifierTest extends TestCase {
	...
	IRule p = createRule(createLiteral(true, "p", "X"), createLiteral(true,
		"u", "X"), createLiteral(false, "r", "X"), createLiteral(false,
		"q", "X"));

	IRule r = createRule(createLiteral(true, "r", "X"), createLiteral(true,
		"s", "X"));

	IRule q = createRule(createLiteral(true, "q", "X"), createLiteral(true,
		"t", "X"), createLiteral(false, "r", "X"));
