...
public class TupleTest extends TestCase {
	...
	assertEquals("The size method doesn't work properly", ARITY, TUPLE
		.size());
    }

    public void testGet() {
	assertEquals("The get method doesn't work properly", TERM
		.createString("a"), TUPLE.get(0));
	assertEquals("The get method doesn't work properly", TERM
		.createString("b"), TUPLE.get(1));
	assertEquals("The get method doesn't work properly", TERM
		.createString("c"), TUPLE.get(2));
    }
