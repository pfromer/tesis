...
public class LiteralTest extends TestCase {
    ...
    private static final IAtom ATOM = BASIC.createAtom(PREDICATE, BASIC
	    .createTuple(TUPLE));
	...
	assertEquals("The getAtom method doesn't work properly", ATOM, lit
		.getAtom());
    }

    public void testEquals() {
	ObjectTests.runTestEquals(new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(BASIC.createAtom(PREDICATE,
		TUPLEMORE)));
	ObjectTests.runTestEquals(new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(!NEGATIVE, BASIC.createAtom(
	...
	ObjectTests.runTestCompareTo(new Literal(BASIC.createAtom(PREDICATE,
		TUPLE)), new Literal(BASIC.createAtom(PREDICATE, TUPLE)),
	...
	ObjectTests.runTestCompareTo(new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLE)), new Literal(NEGATIVE, BASIC.createAtom(
		PREDICATE, TUPLEMORE)), new Literal(BASIC.createAtom(PREDICATE,
		TUPLE)));
    }
