...
public class DateTest extends TestCase {
	...
	ObjectTests.runTestEquals(new DateTerm(YEAR, MONTH, DAY), new DateTerm(
		YEAR, MONTH, DAY), new DateTerm(YEAR, MONTH, DAY + 1));
    }

    public void testCompareTo() {
	ObjectTests.runTestCompareTo(new DateTerm(YEAR, MONTH, DAY),
		new DateTerm(YEAR, MONTH, DAY), new DateTerm(YEAR, MONTH,
			DAY + 1), new DateTerm(YEAR, MONTH, DAY + 2));
    }
