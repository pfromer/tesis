...
public class GMonthTest extends TestCase {
	...
	ObjectTests.runTestCompareTo(new GMonth(MONTH), new GMonth(MONTH),
		new GMonth(MONTH + 1), new GMonth(MONTH + 2));
    }

    public void testHashCode() {
	ObjectTests.runTestHashCode(new GMonth(MONTH), new GMonth(MONTH));
    }
     ...
     *      #1792385: GMonth datatype handles months incorrectly</a>
     */
