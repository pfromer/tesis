...
public class DateTimeTest extends TestCase {
	...
	final DateTime dt = new DateTime(YEAR, MONTH, DAY, HOUR, MINUTE,
		SECOND, TZ_HOUR, TZ_MINUTE);
	...
	DateTime dt0 = new DateTime(YEAR, MONTH, DAY, HOUR, MINUTE, SECOND,
		TZ_HOUR, TZ_MINUTE);
	...
	assertEquals("Something wrong with getHour", HOUR, dt.getHour());
	assertEquals("Something wrong with getMinute", MINUTE, dt.getMinute());
	assertEquals("Something wrong with getSecond", seconds, dt
		.getDecimalSecond());

	DateTime dt0 = new DateTime(YEAR, MONTH, DAY, HOUR, MINUTE, seconds,
		TZ_HOUR, TZ_MINUTE);
	assertEquals("Something wrong with setting or equals", dt, dt0);
    }

    public void testEquals() {
	ObjectTests.runTestEquals(new DateTime(YEAR, MONTH, DAY, HOUR, MINUTE,
		SECOND, TZ_HOUR, TZ_MINUTE), new DateTime(YEAR, MONTH, DAY,
		HOUR, MINUTE, SECOND, TZ_HOUR, TZ_MINUTE), new DateTime(YEAR,
		MONTH, DAY, HOUR, MINUTE, SECOND + 1, TZ_HOUR, TZ_MINUTE));
    }

    public void testCompareTo() {
	ObjectTests.runTestCompareTo(new DateTime(YEAR, MONTH, DAY, HOUR,
		MINUTE, SECOND, TZ_HOUR, TZ_MINUTE), new DateTime(YEAR, MONTH,
		DAY, HOUR, MINUTE, SECOND, TZ_HOUR, TZ_MINUTE),
		new DateTime(YEAR, MONTH, DAY, HOUR, MINUTE, SECOND + 1,
			TZ_HOUR, TZ_MINUTE), new DateTime(YEAR, MONTH, DAY,
			HOUR, MINUTE, SECOND + 2, TZ_HOUR, TZ_MINUTE));
    }

    public void testHashCode() {
	ObjectTests.runTestHashCode(new DateTime(YEAR, MONTH, DAY, HOUR,
		MINUTE, SECOND, TZ_HOUR, TZ_MINUTE), new DateTime(YEAR, MONTH,
		DAY, HOUR, MINUTE, SECOND, TZ_HOUR, TZ_MINUTE));
    }
     ...
     *      #1792385: DateTime datatype handles months incorrectly</a>
     */
	...
	assertTrue(y2000m1d1 + " must be smaller than " + y2000m12d1, y2000m1d1
		.compareTo(y2000m12d1) < 0);
    }
}
