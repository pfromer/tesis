...
public class ArithmeticTest extends TestCase {
	...
	String expectedResults = "r( 2 )." + "r( 3 )." + "r( 4 ).";
	...
	String expectedResults = "r( 0 )." + "r( 1 ).";
	...
	String expectedResults = "a( 0, 3 )." + "a( 1, 4 ).";
	...
	String program = "one( 1 )." + "nine( 9 )." + "ten( 10 )." +
	...
	String expectedResults = "a( 4, 1 )." + "a( 5, 2 ).";
	...
	String expectedResults = "r( -3 )." + "r( -2 )." + "r( -1 ).";
	...
	String expectedResults = "a( 0, 3 )." + "a( 1, 2 ).";
	...
	String program = "a(0.5)." + "a(0.6)." + "a(4.2)." +
	...
	String expectedResults = "d(5.0)." + "d(6.0)." + "d(42.0).";
	...
	String program = "a(2000000000)." + "a(2000000001)." +
	...
	String expectedResults = "e(2000000000)." + "e(2000000001).";

	Helper.evaluateWithAllStrategies(program, expectedResults);
    }

    /**
     * Predict behaviour of divide by zero (infinity) and zero-divide-by-zero
     * (indeterminate) for integer type (see bug 1808309)
     * 
     * @throws Exception
     */
    public void testIntegerDivideByZero() throws Exception {
	String program = "a(-1)." + "a(0)." + "a(1)." + "b(0)."
		+ "d(?Z) :- a(?X), b(?Y), ?X / ?Y = ?Z." + "?-d(?X).";

	String expectedResults = ""; // No special values for indeterminate or
				     // +/- infinity
    ...
    /**
     * Predict behaviour of divide by zero (infinity) and zero-divide-by-zero
     * (indeterminate) for type 'double' (see bug 1808309)
     * 
     * @throws Exception
     */
    public void testFloatingPointDivideByZero() throws Exception {
	String program = "a(-1.0)." + "a(0.0)." + "a(1.0)." + "b(0.0)."
		+ "d(?Z) :- a(?X), b(?Y), ?X / ?Y = ?Z." + "?-d(?X).";

	String expectedResults = ""; // NaN and +/- infinity should not be
				     // produced.
	...
	String program = "a(0.0)." + "a(1.0000000000001)."
		+ "a(_float(2.000001))." +

		"b(-0.0)." + "b(1.0000000000002)." + "b(_float(2.000002))." +

		"p(?x) :- a(?x), b(?y), ! ?x < ?y, ! ?x > ?y." +

		"?- p(?x).";

	String expectedResults = "p(0.0)." + "p(1.0000000000001)."
		+ "p(_float(2.000001)).";
