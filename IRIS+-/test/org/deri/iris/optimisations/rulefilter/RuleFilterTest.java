...
public class RuleFilterTest extends TestCase {
	...
	return new TestSuite(RuleFilterTest.class, RuleFilterTest.class
		.getSimpleName());
    }
     ...
     * 
     * @param query_and_result
     *            the parseable string with the input query and the resulting
     *            rules
     */
	...
	assertEquals(new HashSet<IRule>(resultParser.getRules()), RuleFilter
		.shrinkRules(rulesParser.getRules(), resultParser.getQueries()
			.get(0)));
    }
