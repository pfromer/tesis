...
\underline{Caso $\nBottom \geq \nTop$}: Dado que $\nBottom$ se inicializa en 1, y dado que \nTop se inicializa en n, y que ambos se acercan a la misma velocidad, este caso solo puede ocurrir cuando ya se hayan ejecutado $\parteEntera$ iteraciones. Queremos ver que se ejecutó la iteración $n - |r_0| + 1$, alcanza entonces con ver que  $\parteEntera \geq n - |r_0| + 1$. Dado que $n$ es par resulta que $n - \parteEntera = \parteEntera$. Dado que $|r_0| > \parteEntera$, resulta entonces que $n - |r_0| < \parteEntera$, y por lo tanto $n - |r_0| + 1 \leq \parteEntera$.
